    ...
    <div class="container mx-auto px-4 py-6">
        <div class="bg-white p-6 rounded-lg shadow-md">
            <div class="flex justify-between items-center mb-4">
                ...
                <a href="{{ route('pengabdian.index') }}" class="bg-gray-500 text-white px-4 py-2 rounded hover:bg-gray-600">Kembali</a>
            </div>

            <form action="{{ route('pengabdian.update', $pengabdian->id) }}" method="POST" enctype="multipart/form-data" class="space-y-4">
                @csrf
                @method('PUT')
            ...
            {{-- <div class="bg-white shadow-md rounded-lg p-6 mt-8">
                ...
                <form action="{{ route('pengabdian.luaran.store', $pengabdian->id) }}" method="POST" enctype="multipart/form-data" class="space-y-4">
                    @csrf
                    <div>
