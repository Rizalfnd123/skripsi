...
@section('content')
    <div class="max-w-3xl mx-auto bg-white shadow-lg rounded-lg p-6 relative">
        ...
        <h1 class="text-3xl font-bold text-gray-700 mb-6 text-center">Tambah Penelitian</h1>
        <form action="{{ route('penelitian-dosen.store') }}" method="POST" enctype="multipart/form-data" class="space-y-5">
            @csrf
            <div>
