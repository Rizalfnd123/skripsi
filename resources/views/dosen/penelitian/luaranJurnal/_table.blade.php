        ...
        <table class="min-w-full text-sm bg-white">
            <thead>
                <tr class="bg-purple-100 text-purple-800 font-semibold text-left">
                    ...
                    <th class="px-4 py-3 border-b border-purple-200">Index</th>
            ...
            <tbody>
                @foreach ($luarans as $luaran)
                    <tr class="hover:bg-purple-50 transition">
                        ...
                        <td class="px-4 py-2 border-b border-purple-100">{{ $luaran->sinta }}</td>
                        ...
                        <td class="px-4 py-2 border-b border-purple-100 text-center space-x-1">
                            <a href="{{ route('luaran.penelitian.jurnal.edit.dosen', $luaran->id) }}"
                            ...
                            <form action="{{ route('luaran.penelitian.jurnal.destroy.dosen', $luaran->id) }}"
