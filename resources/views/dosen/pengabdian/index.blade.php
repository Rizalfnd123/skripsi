...
<div class="container mx-auto px-4">
    ...
    <div class="flex justify-between items-center mb-4 bg-white p-4 shadow rounded-lg">
        {{-- Tombol Tambah --}}
        <a href="{{ route('pengabdian-dosen.create') }}" class="bg-blue-500 text-white px-4 py-2 rounded shadow hover:bg-blue-600 transition">
            + Tambah Pengabdian
        </a>
                ...
                @foreach ($pengabdian as $item)
                    <tr class="border-b hover:bg-gray-50">
                        ...
                        <td class="py-3 px-4 border text-center">
                            <a href="{{ route('pengabdian-dosen.edit', $item->id) }}" class="text-blue-500 hover:underline">Edit</a> |
                            <form action="{{ route('pengabdian-dosen.destroy', $item->id) }}" method="POST" class="inline">
                                @csrf
                                @method('DELETE')
