        ...
        <table class="min-w-full text-sm bg-white">
            <thead>
                <tr class="bg-purple-100 text-left text-purple-800 font-semibold">
                    <th class="px-4 py-3 border-b border-purple-200">Judul Buku</th>
                    <th class="px-4 py-3 border-b border-purple-200">Judul Pengabdian</th>
                    <th class="px-4 py-3 border-b border-purple-200">Nomor ISBN</th>
                    <th class="px-4 py-3 border-b border-purple-200">Tahun</th>
                    <th class="px-4 py-3 border-b border-purple-200">Penulis</th>
                    <th class="px-4 py-3 border-b border-purple-200">Nama Jurnal</th>
            ...
            <tbody>
                @foreach ($luarans as $luaran)
                    <tr class="hover:bg-purple-50 transition">
                        ...
                        <td class="px-4 py-2 border-b border-purple-100">{{ $luaran->isbn }}</td>
                        ...
                        <td class="px-4 py-2 border-b border-purple-100">{{ $luaran->penerbit }}</td>
                        ...
                        <td class="px-4 py-2 border-b border-purple-100 text-center space-x-1">
                            <a href="{{ route('luaran.pengabdian.buku.edit.dosen', $luaran->id) }}"
                               class="inline-block bg-yellow-400 text-white px-3 py-1 rounded text-xs hover:bg-yellow-500 transition">
                                Edit
                            </a>
                            <form action="{{ route('luaran.pengabdian.buku.destroy.dosen', $luaran->id) }}"
