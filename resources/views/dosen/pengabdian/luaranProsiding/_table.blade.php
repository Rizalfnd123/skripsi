        ...
        <table class="min-w-full bg-white border border-gray-300 text-sm">
            <thead>
                <tr class="bg-gray-100 text-left text-gray-700 font-semibold">
                    <th class="px-4 py-3 border-b">Nama Konferensi</th>
                    <th class="px-4 py-3 border-b">Penyelenggara</th>
                    {{-- <th class="px-4 py-3 border-b">Tanggal Konferensi</th> --}}
                    {{-- <th class="px-4 py-3 border-b">Tempat Konferensi</th> --}}
                    <th class="px-4 py-3 border-b">Judul Pengabdian</th>
                    <th class="px-4 py-3 border-b">Judul Jurnal</th>
                    <th class="px-4 py-3 border-b">Tahun</th>
                    <th class="px-4 py-3 border-b">Penulis</th>
                    {{-- <th class="px-4 py-3 border-b">Nama Jurnal</th> --}}
                    {{-- <th class="px-4 py-3 border-b">Sinta</th> --}}
            ...
            <tbody>
                @foreach ($luarans as $luaran)
                    <tr class="hover:bg-gray-50 transition">
                        <td class="px-4 py-2 border-b">{{ $luaran->nama_konferensi }}</td>
                        <td class="px-4 py-2 border-b">{{ $luaran->penyelenggara }}</td>
                        {{-- <td class="px-4 py-2 border-b">{{ $luaran->tgl_konferensi }}</td> --}}
                        {{-- <td class="px-4 py-2 border-b">{{ $luaran->tempat_konferensi }}</td> --}}
                        ...
                        {{-- <td class="px-4 py-2 border-b">{{ $luaran->sinta }}</td> --}}
                        ...
                        <td class="px-4 py-2 border-b text-center">
                            <a href="{{ route('luaran.pengabdian.prosiding.edit.dosen', $luaran->id) }}"
                                class="inline-block bg-yellow-400 text-white px-3 py-1 rounded text-xs hover:bg-yellow-500 mr-2 transition">
                                Edit
                            </a>
                            <form action="{{ route('luaran.pengabdian.prosiding.destroy.dosen', $luaran->id) }}" method="POST" class="inline-block"
