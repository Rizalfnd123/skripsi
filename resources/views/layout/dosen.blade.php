...
<body class="bg-gray-100 text-gray-800 transition-colors duration-300">
    ...
    <div class="flex transition-all duration-300">
        <!-- Sidebar -->
        <div id="sidebar"
            class="w-56 bg-gray-100 text-gray-800 fixed top-14 h-[calc(100vh-3.5rem)] z-40 shadow-lg -translate-x-64 transition-transform duration-300">
            <ul class="space-y-1 px-2 py-3">
                ...
                <li class="p-1.5 flex items-center hover:bg-gray-400/20 rounded cursor-pointer">
                    <a href="{{ route('penelitian-dosen.index') }}" class="flex items-center w-full px-3 py-2 rounded">
                        <span class="material-icons text-gray-600 mr-2">book</span>
                        Penelitian
                    </a>
                </li>
                <li class="p-1.5 flex items-center hover:bg-gray-400/20 rounded cursor-pointer">
                    <a href="{{ route('pengabdian-dosen.index') }}" class="flex items-center w-full px-3 py-2 rounded">
                ...
                {{-- <li class="p-1.5 flex items-center hover:bg-gray-400/20 rounded cursor-pointer">
                    <a href="{{ route('rekapadmin.index') }}" class="flex items-center w-full px-3 py-2 rounded">
                        <span class="material-icons text-gray-600 mr-2">folder</span>
                        Rekap
                    </a>
                </li> --}}
